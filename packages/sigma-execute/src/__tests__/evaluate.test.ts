...
describe('evaluateAction', () => {
  ...
  describe('money actions', () => {
    it('denies a typical money transfer', () => {
      const outcome = evaluateAction(buildOnChainMoneyRequest(), clock);
      expect(outcome.status).toBe('denied');
    });

    it('denies a zero-amount money transfer', () => {
    ...
    it('denies a large money transfer', () => {
      const outcome = evaluateAction(
    ...
    it('denies a money transfer regardless of currency or asset', () => {
      const outcome = evaluateAction(
    ...
    it('denies a money transfer regardless of recipient', () => {
      const outcome = evaluateAction(
    ...
    it('denies a money transfer even when described as low-risk', () => {
      const outcome = evaluateAction(
    ...
    it('stamps the denial with the injected clock time, not wall-clock time', () => {
      const outcome = evaluateAction(buildOnChainMoneyRequest(), clock);
